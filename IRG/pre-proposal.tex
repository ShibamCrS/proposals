...
% \title{Design and Analysis of Low-Latency Crypto and its Application}

\title{\sffamily\bfseries\Large\textcolor{theme}{\soptitle}}\par
\author{
    Shibam Ghosh\textsuperscript{1} \quad Dhiman Saha\textsuperscript{2} \\[1ex]
    \normalsize \textsuperscript{1}Indian Institute of Technology Hyderabad 
    \normalsize \textsuperscript{2}Indian Institute of Technology Bhilai
}
...
\section{{\bfseries Design and Analysis of Symmetric Key Primitives for Zero-knowledge Protocols}}
\vspace*{-0.3cm}
...
\subsubsection{Why ZKPs are Important?}
\vspace*{-0.1cm}
